package net.huansi.job.admin.core.trigger;
...
/**
 * xxl-job trigger
 * Created by falcon on 17/7/13.
 */
public class HsJobTrigger {
    private static Logger logger = LoggerFactory.getLogger(HsJobTrigger.class);
    ...
    public static void trigger(int jobId,
        ...
        // load data
        HsJobInfo jobInfo = XxlJobAdminConfig.getAdminConfig().getXxlJobInfoDao().loadById(jobId);
        if (jobInfo == null) {
        ...
        HsJobGroup group = XxlJobAdminConfig.getAdminConfig().getXxlJobGroupDao().load(jobInfo.getJobGroup());
     ...
     */
    private static void processTrigger(HsJobGroup group, HsJobInfo jobInfo, int finalFailRetryCount, TriggerTypeEnum triggerType, int index, int total){
