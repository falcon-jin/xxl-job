...
public class OkHttpUtils {
    ...
    public OkHttpUtils post(boolean isJsonPost,Object body) {
        RequestBody requestBody;
        if (isJsonPost) {
            String json = "";
            if (body != null) {
                json = GsonTool.toJson(body);
            }
            requestBody = RequestBody.create( json,MediaType.parse("application/json; charset=utf-8"));
        } else {
            FormBody.Builder formBody = new FormBody.Builder();
     ...
     * @throws Exception
     */
    public OkHttpUtils put(byte[] data) throws Exception {
        RequestBody requestBody;
        requestBody = RequestBody.create(data);
